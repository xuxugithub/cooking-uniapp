...
const getDishPage = (params) => {
  return utils_request.get("/app/dish/page", params);
};
const getDishById = (id) => {
  return utils_request.get(`/app/dish/${id}`);
};
const getDishSteps = (dishId) => {
  return utils_request.get(`/app/dish-step/list/${dishId}`);
};
const getDishIngredients = (dishId) => {
  return utils_request.get(`/app/dish-ingredient/list/${dishId}`);
};
const searchDish = (keyword, params = {}) => {
  return utils_request.get("/app/dish/search", { keyword, ...params });
};
const increaseViewCount = (dishId) => {
  return utils_request.post(`/app/dish/${dishId}/view`);
};
const toggleFavorite = (dishId) => {
  return utils_request.post(`/app/dish/${dishId}/favorite`);
};
const recordViewHistory = (dishId) => {
  return utils_request.post(`/app/dish/${dishId}/view-history`);
};
const getAllDishes = (params = {}) => {
  return utils_request.get("/app/dish/all", params);
};
