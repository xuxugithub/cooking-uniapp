...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o((...args) => $options.onSearchConfirm && $options.onSearchConfirm(...args), "56"),
    c: $data.keyword,
    d: common_vendor.o((...args) => $options.onSearchConfirm && $options.onSearchConfirm(...args), "e8"),
    e: !$data.hasSearched
  }, !$data.hasSearched ? common_vendor.e({
    f: $data.searchHistory.length > 0
  }, $data.searchHistory.length > 0 ? {
    g: common_vendor.o((...args) => $options.onClearHistory && $options.onClearHistory(...args), "4e"),
